    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          '_____ is the reason I drink heavily'
        )
      );
    }
  }]);
...
var _questions = __webpack_require__(70);

var _questions2 = _interopRequireDefault(_questions);

var _answers = __webpack_require__(77);

var _answers2 = _interopRequireDefault(_answers);

var _players = __webpack_require__(78);
...
var questionCards = _db2.default.blackCards;
...
var questions = function questions() {
  ...
  switch (action.type) {
    case 'SELECT_QUESTION':
      var randomNumber = Math.floor(Math.random() * questionCards.length + 1);
      var selectedQuestion = questionCards[randomNumber].text;
      return {
        currentQuestion: selectedQuestion,
        dealtQuestions: [].concat(_toConsumableArray(state.dealtQuestions), [selectedQuestion])
      };
    default:
      return state;
  }
...
var _PlayerHand = __webpack_require__(74);

var _PlayerHand2 = _interopRequireDefault(_PlayerHand);

var _StartGame = __webpack_require__(75);

var _StartGame2 = _interopRequireDefault(_StartGame);

var _EndRound = __webpack_require__(76);
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_PlayerHand2.default, null),
    _react2.default.createElement(_EndRound2.default, null)
  );
};
...
var PlayerHand = function (_Component) {
  _inherits(PlayerHand, _Component);

  function PlayerHand(props) {
    _classCallCheck(this, PlayerHand);

    var _this = _possibleConstructorReturn(this, (PlayerHand.__proto__ || Object.getPrototypeOf(PlayerHand)).call(this, props));
  ...
  _createClass(PlayerHand, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { 'class': 'alert alert-dark alert-warning alert-dismissible fade show', role: 'alert' },
          _react2.default.createElement(
            'strong',
            null,
            'Take your pick'
        ...
        _react2.default.createElement(
          'ul',
          null,
          _react2.default.createElement('input', { type: 'radio', name: 'answer', value: '', id: '' }),
          _react2.default.createElement(
            'label',
            { 'for': 'answer1' },
            'Smegma'
...
var EndRound = function (_Component) {
  _inherits(EndRound, _Component);

  function EndRound(props) {
    _classCallCheck(this, EndRound);

    var _this = _possibleConstructorReturn(this, (EndRound.__proto__ || Object.getPrototypeOf(EndRound)).call(this, props));
  ...
  _createClass(EndRound, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Question2.default, null),
        'answers 1 hidden answers 2 hidden',
        _react2.default.createElement(
          'button',
          { onClick: true },
          ' Submit '
...
var answerCards = _db2.default.whiteCards;
